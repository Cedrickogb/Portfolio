    ...
    return (
        <div className="flex flex-col space-y-10 border-gray-200 p-4 animate-moveToleft">
            ...
            <div className='flex flex-col space-y-2'>
                ...
                <p className="text-center text-white ">Do you need my services or have any suggestions for me? This short section will help you.</p>
            </div>
            ...
            <div className='flex flex-col lg:flex-row w-full gap-2 lg:gap-6  justify-center items-center'>
                <div className='flex justify-center items-center space-x-2 hover:text-lime-500 transition-all duration-700 text-white cursor-pointer'>
                    ...
                    <h2 className="text-xl lg:text-2xl">+229 96 17 23 75</h2>
                </div>
                <div className='flex justify-center items-center space-x-2 hover:text-lime-500 transition-all duration-700 text-white cursor-pointer'>
                    <svg className='w-8 h-8' viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className='flex justify-center items-center space-x-2 hover:text-lime-500 transition-all duration-700 text-white cursor-pointer' onClick={() => window.open("mailto:cedrickogoubiyi13@gmail.com")}>
                    ...
                    <h2 className="text-xl lg:text-2xl">cedrickogoubiyi13@gmail.com</h2>
                </div>
            </div>
