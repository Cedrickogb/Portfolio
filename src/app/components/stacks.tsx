        ...
        <div className="flex flex-col space-y-4 p-6 lg:p-10 z-20 animate-moveToleft">
            <div className="flex flex-wrap gap-2 lg:gap-4 justify-center lg:p-6 rounded-2xl">
                ...
                <div className="group flex flex-col justify-center items-center space-y-2">
                    ...
                    <div className="relative p-2 text-white bg-neutral-600/40 hover:bg-neutral-600/80 transition duration-700 cursor-pointer rounded-2xl overflow-hidden">
                        <div className="flex flex-col justify-center items-center space-y-2 p-2">
                            <svg className='w-20 h-20' viewBox="0 0 1610.00 1610.00" xmlns="http://www.w3.org/2000/svg" fill="#0891b2" stroke="#0891b2" stroke-width="38.64">
                        ...
                        <div className="absolute bottom-0 right-0 group-hover:translate-y-[-180%] group-hover:translate-x-[-300%] flex w-24 h-24 bg-cyan-600  rounded-full filter blur-2xl -z-10 transition duration-700"></div>
                        <div className="absolute top-0 right-[30%] group-hover:translate-y-[50%] group-hover:translate-x-[100%] flex w-32 h-32 bg-cyan-600  rounded-full filter blur-2xl -z-10 transition duration-700"></div>
                        <div className="absolute bottom-[-5%] left-[-5%] group-hover:translate-y-[10%] group-hover:translate-x-[120%] flex w-40 h-40 bg-cyan-600  rounded-full filter blur-2xl -z-10 transition duration-700"></div>
                    </div>
                    <h1 className="invisible group-hover:visible text-sm font-medium">Electron js</h1>
                </div>
