                  ...
                  <div className="flex-1 flex flex-col">
                    <div className="flex items-center gap-2 mb-2">
                      <h3 className="text-xl font-display text-gray-900 dark:text-white leading-tight transition-colors">
                        ...
                        { quest.id == 'aso' && <span className='text-xs'>(All Signs Customizer)</span>}
                      </h3>
                    </div>
                    ...
                    <div className="mt-auto">
                      ...
                      {/* <a href={`/projects/${quest.id}`} target='blank' className="block w-full text-center py-3 px-4 rounded bg-gray-100 dark:bg-gray-800 text-gray-900 dark:text-white font-display text-xs hover:bg-primary hover:text-black transition-colors border border-gray-200 dark:border-gray-600 group-hover:border-primary">
                        START QUEST
                      </a> */}
                    </div>
                  </div>
