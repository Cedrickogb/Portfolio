      ...
      <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
        ...
        <div className="flex items-center gap-3 group cursor-pointer" onClick={() => window.scrollTo(0, 0)}>
          ...
          <div className="flex flex-col">
            ...
            <div className="w-20 sm:w-24 h-2 bg-gray-300 dark:bg-gray-800 rounded-full mt-1 overflow-hidden border border-gray-200 dark:border-gray-700">
              <div className="h-full bg-hp-red w-[85%]"></div>
            </div>
          </div>
        </div>
        ...
        <div className="hidden md:flex items-center gap-8">
            ...
            <div className="flex items-center gap-4">
                ...
                <a href="#" aria-label="Github" className="p-2 bg-gray-100 dark:bg-gray-800 hover:bg-white dark:hover:bg-gray-700 rounded border border-gray-300 dark:border-gray-600 hover:border-primary dark:hover:border-primary transition-all text-gray-600 dark:text-gray-300 hover:text-primary">
                    <i className="fab fa-github"></i>
                </a>
                <a href="#" aria-label="LinkedIn" className="p-2 bg-gray-100 dark:bg-gray-800 hover:bg-white dark:hover:bg-gray-700 rounded border border-gray-300 dark:border-gray-600 hover:border-primary dark:hover:border-primary transition-all text-gray-600 dark:text-gray-300 hover:text-primary">
