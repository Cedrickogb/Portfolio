                ...
                <div className="flex flex-col space-y-3 lg:grid lg:grid-cols-2 lg:gap-2 lg:px-2 lg:py-6">
                    ...
                    <div className=" px-2 text-white bg-neutral-600 bg-opacity-40 hover:bg-slate-100 hover:text-black transition duration-700 cursor-pointer ">
                        <div className="p-2">
                            ...
                            <p className="py-2">Le JavaScript est un langage de programmation dynamique complet qui utilsé sur un document HTML peut fournir une interactivité dynamique sur les sites Web, c'est un puissant outil de dynamisation de site web.</p>
                        </div>
                    </div>
                    ...
                    <div className=" px-2 text-white bg-neutral-600 bg-opacity-40 hover:bg-slate-100 hover:text-black transition duration-700 cursor-pointer">
                        <div className="p-2">
                            ...
                            <p className="py-2"> Concernant le developpement de solution informatique je ne taris pas d'idées et de ressources, également talentueux en dessin et ayant été responsable et instructeur dans cette discipline pour des collegiens, j'ai de très bonnes idées pour le graphisme et le design.</p>
                        </div>
                    </div>
