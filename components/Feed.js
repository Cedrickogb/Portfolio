            ...
            <div className="xl:ml-[250px] xl:pl-[120px] border-b border-gray-200  sm:ml-[230px] px-10 py-5 ">
                ...
                <div className="grid grid-cols-2 gap-2 px-2 py-6">
                    ...
                    <div className=" px-2 text-white bg-neutral-600 bg-opacity-40 hover:bg-slate-100 hover:text-black transition duration-700 cursor-pointer">
                        ...
                        <p className="py-2"> Concernant le developpement de solution informatique je ne taris pas d'idées et de ressources, également talentueux en dessin et ayant été responsable et instructeur cette discipline pour des collegiens, j'ai de très bonnes idées pour le graphisme et le design.</p>
