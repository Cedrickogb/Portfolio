                    ...
                    <div className="px-2">
                        ...
                        <form ref={form} onSubmit={sendEmail} className="flex-col px-2 text-center">
                            <div className="py-2 text-center">
                                <input type="text" id="fullName" name="name" className="pr-20 bg-neutral-600  placeholder:text-gray-900 bg-opacity-60 text-white border" placeholder="nom et prenom..."/>
                            </div>
                            <div className="py-2 text-center">
                                <input type="text" id="email_id" name="email" className="pr-20 bg-neutral-600  placeholder:text-gray-900 bg-opacity-60 text-white border" placeholder="email..."/>
                            </div>
                            <div className="py-2 text-center">
                                <textarea type="text" id="message" name="message" className="bg-neutral-600  placeholder:text-gray-900 resize bg-opacity-60 text-white border pr-[130px]" placeholder="message..."/>
                            </div>
